...
public class ApolloAuthServiceImpl implements AuthService<HttpServletRequest> {

	private static final Logger LOGGER = LoggerFactory.getLogger(ApolloAuthServiceImpl.class);
	...
	public AuthUser getAuthUser(HttpServletRequest request) {
		try {
			String username = apolloAuthManager.getUsername(request);
			if (username != null) {
				return new ApolloAuthUserImpl(username);
			}
		} catch (Exception e) {
	...
	public static final class ApolloAuthUserImpl implements AuthUser {

		private String username;

		public ApolloAuthUserImpl(String username) {
